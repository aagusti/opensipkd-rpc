--QUERY SCORE KELURAHAN
SELECT drv2.kd_propinsi , drv2.kd_dati2 , drv2.kd_kecamatan, drv2.kd_kelurahan, k2.nm_kecamatan, k1.nm_kelurahan, 
...
INNER JOIN ref_kelurahan k1
          ON  drv2.kd_propinsi = k1.kd_propinsi 
              and drv2.kd_dati2 = k1.kd_dati2
              and drv2.kd_kecamatan = k1.kd_kecamatan
              and drv2.kd_kelurahan = k1.kd_kelurahan
INNER JOIN ref_kecamatan k2
          ON  k2.kd_propinsi = k1.kd_propinsi 
              and k2.kd_dati2 = k1.kd_dati2
              and k2.kd_kecamatan = k1.kd_kecamatan
--ORDER BY 15 DESC LIMIT 10; --; Penilaian se pemda
ORDER BY 1,2,3,15,4 DESC ; --; Penilaian per kecamatan
