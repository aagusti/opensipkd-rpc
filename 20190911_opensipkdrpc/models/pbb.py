...
class DatSubjekPajak(pbb_Base, CommonModel):
    ...
    @classmethod
    def get_dsp(cls, p_kode):
        #Digunakan untuk mendapatkan data subjek pajak
        #parameter kode/nik
        #irul@20180406

        query = pbb_DBSession.query(
                  cls.subjek_pajak_id, cls.nm_wp, cls.jalan_wp, cls.blok_kav_no_wp, cls.rw_wp, cls.rt_wp,
                  cls.kelurahan_wp, cls.kota_wp, cls.kd_pos_wp, cls.telp_wp, cls.npwp, cls.status_pekerjaan_wp)
        return query.filter(cls.subjek_pajak_id == p_kode)
